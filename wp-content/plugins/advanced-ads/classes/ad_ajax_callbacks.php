<?php
	...
	class Advanced_Ads_Ad_Ajax_Callbacks{
		...
		public function close_notice(){
			...
			if(!current_user_can(Advanced_Ads_Plugin::user_cap('advanced_ads_manage_options')) || empty($_REQUEST['notice'])){
				die();
			}
		...
		public function hide_notice(){
			...
			if(!current_user_can(Advanced_Ads_Plugin::user_cap('advanced_ads_manage_options')) || empty($_POST['notice'])){
				die();
			}
