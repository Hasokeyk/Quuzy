...
<section class="profile-detail">
    ...
    <div class="profile-content">
        ...
        <div class="profile-posts">
            ...
            <div class="posts">
            <?php
                $posts = $mysqli->query("SELECT * FROM userposts WHERE username='".$urlParse['subFolder']."' ORDER BY id ASC");
                if($posts->num_rows > 0){
                    $ads = 0;
                        ...
                        <div class="post-info-detail">
                            <ul>
                                ...
                                <li class="download-btn">
                                    ...
                                    <div class="text"><a href="<?=$imgLink?><?=$post['shortcode']?>/" download="<?=$post['shortcode']?>.png">Download</a></div>
                                </li>
                            </ul>
                        </div>
                    </div>
